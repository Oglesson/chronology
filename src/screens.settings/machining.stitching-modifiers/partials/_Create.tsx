...
export const Create = () => {
	...
	type StitchingModifierFormData = z.infer<
		typeof stitchingModifierFormSchema
	>;
	...
	const {
		...
		resolver: zodResolver(stitchingModifierFormSchema),
	});
	const onSubmit = (data: StitchingModifierFormData) => console.log(data);
	...
	useEffect(() => {
		window.requestAnimationFrame(() => {
			setCreateButton(
				<Button
					text={t("createAStitchingModifier")}
			...
			<Modal isOpen={openModal}>
				...
				>
					<input
						...
						value={FORM_IDENTIFIERS.createStitchingModifier}
					/>
					<Input
						error={errors.no}
						htmlFor={"no"}
