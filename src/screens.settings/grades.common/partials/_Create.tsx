...
export const Create = () => {
	...
	const gradeFormSchema = useGradeFormSchema(gradeCodes);
	...
	const onSubmit = (data: GradeFormData) => console.log(data);
	...
	useEffect(() => {
		window.requestAnimationFrame(() => {
			setCreateButton(
				<Button text={t("createAGrade")} onClick={setOpenModal} disabled={!canEdit} />
			);
		});
